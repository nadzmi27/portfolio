...
<figure>
  ...
  <figcaption>High-level architecture — the React client communicates with Supabase for auth and data, Merriam-Webster APIs for dictionary lookups, and Cloudflare for hosting and audio delivery</figcaption>
</figure>
